...
public class MineFlag extends Item {
    public MineFlag (Properties properties) {
        super(properties);
    }
    ...
    public ActionResultType useOn (ItemUseContext ctx) {
        ...
        if (!world.isClientSide() && state.getBlock() == ItemsAndBlocks.Blocks.MINESWEEPER_BLOCK.get()) {
            world.setBlockAndUpdate(pos, ItemsAndBlocks.Blocks.MINESWEEPER_FLAG.get().defaultBlockState());
            return ActionResultType.SUCCESS;
        }
        if (!world.isClientSide() && state.getBlock() == ItemsAndBlocks.Blocks.MINESWEEPER_FLAG.get()) {
            world.setBlockAndUpdate(pos, ItemsAndBlocks.Blocks.MINESWEEPER_BLOCK.get().defaultBlockState());
            return ActionResultType.SUCCESS;
        }
